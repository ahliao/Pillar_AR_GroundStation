// From libkovan at https://github.com/kipr/
	...
	: m_valid(true)
{
	...
	//setHost(host);
	m_addr.sin_addr.s_addr = inet_addr(host); // just use IP address
...
{	// double colon notation is to use the global namespace var
